...
class TestMCMerchantStoreBannerViewSet(TestCase):
    ...
    def test_mc_merchant_store_banner_create(self):
    ...
    def test_mc_merchant_store_banner_create_permissions_failed(self):
        store_res = self.client.post(
            reverse('mc-merchant-store-list'),
            data={
                'name': 'ANASAE Store',
    ...
    def test_mc_merchant_store_banner_create_error(self):
        store_res = self.client.post(
            reverse('mc-merchant-store-list'),
            data={
                'name': 'ANASAE Store',
